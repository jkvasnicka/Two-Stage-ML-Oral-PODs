...
#region: _initialize_dispatcher
    def _initialize_dispatcher(self):
        ...
        _dispatcher = {
            ...
            'cross_route_pod_comparison' : self._cross_route_pod_comparison
        }
...
#region: _vapor_concentration_ceiling
    ...
    def _cross_route_pod_comparison(self):
        '''Call the cross-route POD plotting workflow.'''
        config_files = self._plot_settings.cross_route_config_files
        cross_route.cross_route_pod_comparison(
            config_files['oral'],
            config_files['inhalation'],
            self._plot_settings,
            output_dir=self._path_settings.figures_dir,
        )
